...
void bad_request(int client)
{
  ...
  send(client, buf, sizeof(buf), 0);
  sprintf(buf, "such a POST without a Content-Length.\r\n");
  send(client, buf, sizeof(buf), 0);
}
/**********************************************************************/
...
void cat(int client, FILE *resouce)
{
  ...
  fget(buf, sizeof(buf), resouce);
  while (!feof(resource))
  {
    send(client, buf, strlen(buf), 0);
    fget(buf, sizeof(buf), resource);
  }
}
/**********************************************************************/
...
int main(void)
{
  ...
  while (1) {
    ...
    if (client_sock == -1)
      ...
      /*accpet_request(client_sock)*/
    if (pthread_create(&new thread, NULL, (void *)& client_sock != 0))
